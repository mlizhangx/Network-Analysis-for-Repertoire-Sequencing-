...
* Setting `output_dir` to `NULL` will prevent the output from being saved.


## <a name = "output_format"></a> Output File Format

* By default, each component of the list returned by `buildRepSeqNetwork` is saved as its own file using the following file formats:
