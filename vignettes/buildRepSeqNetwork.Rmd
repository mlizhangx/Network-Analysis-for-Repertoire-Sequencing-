...
Plots can be customized through [optional arguments](https://mlizhangx.github.io/Network-Analysis-for-Repertoire-Sequencing-/articles/network_visualization.html) to `buildRepSeqNetwork()` as well as by [modifying them](https://mlizhangx.github.io/Network-Analysis-for-Repertoire-Sequencing-/articles/network_visualization.html#modifying-plots-after-creation) after they are created.
...
The `igraph` object can be used for [downstream computation of network properties](#downstream), as an alternative to [computing network properties when calling `buildRepSeqNetwork()`](#network_properties). It can also be used to [generate additional plots of the network graph](https://mlizhangx.github.io/Network-Analysis-for-Repertoire-Sequencing-/articles/network_visualization.html#generating-new-plots).
...
For details on the clustering algorithms, refer to [this documentation file](https://mlizhangx.github.io/Network-Analysis-for-Repertoire-Sequencing-/reference/clustering_algorithms.html), which can be accessed offline using the command `?clustering_algorithms` in R.
...
The `buildRepSeqNetwork()` function includes various arguments that facilitate customization of the network visualization. See [this vignette](https://mlizhangx.github.io/Network-Analysis-for-Repertoire-Sequencing-/articles/network_visualization.html) for an overview.
...
Refer to [this article](https://mlizhangx.github.io/Network-Analysis-for-Repertoire-Sequencing-/articles/network_visualization.html#modifying-plots-after-creation) for further details.
...
* [Generation of visual plot](https://mlizhangx.github.io/Network-Analysis-for-Repertoire-Sequencing-/articles/network_visualization.html#generating-new-plots)
