...
## Specifying the Clone Frequency Column (Optional)
...
# <a name="step2"></a> Step 2: Find Associated Clones
...
## Assigning Subject IDs and Sample IDs (Optional)
...
## Specifying the Neighborhood Data Files

The files created by `findAssociatedClones` in the [previous step](#step2) contain the data for each neighborhood. These files are provided to `buildAssociatedClusterNetwork` by supplying a character vector of file paths to the `file_list` argument. We create this vector below.
