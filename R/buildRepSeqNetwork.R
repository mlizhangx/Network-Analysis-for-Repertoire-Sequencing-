...
buildRepSeqNetwork <- function(
  ...
  if (is.null(out)) {
    warning("Graph contains no nodes; returning NULL. You may wish to consider another distance type or a greater distance cutoff, or setting `drop_isolated_nodes = FALSE`")
