...
#>   C:\Users\Brian\AppData\Local\Temp\Rtmpk1dCJ0/MyRepSeqNetwork_NodeMetadata.csv
```

<img src="man/figures/README-unnamed-chunk-5-1.png" width="100%" style="display: block; margin: auto;" />

    #> Network graph plots saved to file:
    #>   C:\Users\Brian\AppData\Local\Temp\Rtmpk1dCJ0/MyRepSeqNetwork.pdf
    #> Network igraph saved in edgelist format to file:
    #>   C:\Users\Brian\AppData\Local\Temp\Rtmpk1dCJ0/MyRepSeqNetwork_EdgeList.txt
    #> Adjacency matrix saved to file:
    #>   C:\Users\Brian\AppData\Local\Temp\Rtmpk1dCJ0/MyRepSeqNetwork_AdjacencyMatrix.mtx
...
head(input_files)
#> [1] "C:\\Users\\Brian\\AppData\\Local\\Temp\\Rtmpk1dCJ0/input_samples/Sample1.rds"
#> [2] "C:\\Users\\Brian\\AppData\\Local\\Temp\\Rtmpk1dCJ0/input_samples/Sample2.rds"
#> [3] "C:\\Users\\Brian\\AppData\\Local\\Temp\\Rtmpk1dCJ0/input_samples/Sample3.rds"
#> [4] "C:\\Users\\Brian\\AppData\\Local\\Temp\\Rtmpk1dCJ0/input_samples/Sample4.rds"
#> [5] "C:\\Users\\Brian\\AppData\\Local\\Temp\\Rtmpk1dCJ0/input_samples/Sample5.rds"
#> [6] "C:\\Users\\Brian\\AppData\\Local\\Temp\\Rtmpk1dCJ0/input_samples/Sample6.rds"
```
...
#> Processing sample 1 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 2 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 3 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 4 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 5 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 6 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 7 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 8 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 9 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 10 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 11 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 12 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 13 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 14 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 15 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 16 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 17 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 18 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 19 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 20 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 21 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 22 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 23 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 24 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 25 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 26 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 27 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 28 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 29 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
#> Processing sample 30 of 30:
#> Input data contains 30 rows.
#> Finding clones in a neighborhood of each associated sequence... Done.
...
#>   C:\Users\Brian\AppData\Local\Temp\Rtmpk1dCJ0/assoc_seq_nbds
```
...
nbd_files
#> [1] "C:\\Users\\Brian\\AppData\\Local\\Temp\\Rtmpk1dCJ0/assoc_seq_nbds/AAAAAA.csv"
```
...
#>  Done.
#> Node-level meta-data saved to file:
#>   C:\Users\Brian\AppData\Local\Temp\Rtmpk1dCJ0/assoc_clusters/AssociatedClusterNetwork_NodeMetadata.csv
#> Cluster-level meta-data saved to file:
#>   C:\Users\Brian\AppData\Local\Temp\Rtmpk1dCJ0/assoc_clusters/AssociatedClusterNetwork_ClusterMetadata.csv
```

<img src="man/figures/README-unnamed-chunk-28-1.png" width="100%" style="display: block; margin: auto;" />

    #> Network graph plots saved to file:
    #>   C:\Users\Brian\AppData\Local\Temp\Rtmpk1dCJ0/assoc_clusters/AssociatedClusterNetwork.pdf
    #> Network igraph saved in edgelist format to file:
    #>   C:\Users\Brian\AppData\Local\Temp\Rtmpk1dCJ0/assoc_clusters/AssociatedClusterNetwork_EdgeList.txt
    #> Adjacency matrix saved to file:
    #>   C:\Users\Brian\AppData\Local\Temp\Rtmpk1dCJ0/assoc_clusters/AssociatedClusterNetwork_AdjacencyMatrix.mtx
...
#>   C:\Users\Brian\AppData\Local\Temp\Rtmpk1dCJ0/filtered_samples
```
...
#> [1] "C:\\Users\\Brian\\AppData\\Local\\Temp\\Rtmpk1dCJ0/filtered_samples/node_meta_data/Sample1.rds" 
#> [2] "C:\\Users\\Brian\\AppData\\Local\\Temp\\Rtmpk1dCJ0/filtered_samples/node_meta_data/Sample10.rds"
#> [3] "C:\\Users\\Brian\\AppData\\Local\\Temp\\Rtmpk1dCJ0/filtered_samples/node_meta_data/Sample11.rds"
#> [4] "C:\\Users\\Brian\\AppData\\Local\\Temp\\Rtmpk1dCJ0/filtered_samples/node_meta_data/Sample12.rds"
#> [5] "C:\\Users\\Brian\\AppData\\Local\\Temp\\Rtmpk1dCJ0/filtered_samples/node_meta_data/Sample13.rds"
#> [6] "C:\\Users\\Brian\\AppData\\Local\\Temp\\Rtmpk1dCJ0/filtered_samples/node_meta_data/Sample14.rds"
...
#> [1] "C:\\Users\\Brian\\AppData\\Local\\Temp\\Rtmpk1dCJ0/filtered_samples/cluster_meta_data/Sample1.rds" 
#> [2] "C:\\Users\\Brian\\AppData\\Local\\Temp\\Rtmpk1dCJ0/filtered_samples/cluster_meta_data/Sample10.rds"
#> [3] "C:\\Users\\Brian\\AppData\\Local\\Temp\\Rtmpk1dCJ0/filtered_samples/cluster_meta_data/Sample11.rds"
#> [4] "C:\\Users\\Brian\\AppData\\Local\\Temp\\Rtmpk1dCJ0/filtered_samples/cluster_meta_data/Sample12.rds"
#> [5] "C:\\Users\\Brian\\AppData\\Local\\Temp\\Rtmpk1dCJ0/filtered_samples/cluster_meta_data/Sample13.rds"
#> [6] "C:\\Users\\Brian\\AppData\\Local\\Temp\\Rtmpk1dCJ0/filtered_samples/cluster_meta_data/Sample14.rds"
```
...
#>  Done.
#> Node-level meta-data saved to file:
#>   C:\Users\Brian\AppData\Local\Temp\Rtmpk1dCJ0/public_clusters/PublicClusterNetwork_NodeMetadata.csv
#> Cluster-level meta-data saved to file:
#>   C:\Users\Brian\AppData\Local\Temp\Rtmpk1dCJ0/public_clusters/PublicClusterNetwork_ClusterMetadata.csv
```

<img src="man/figures/README-unnamed-chunk-35-1.png" width="100%" style="display: block; margin: auto;" />

    #> Network graph plots saved to file:
    #>   C:\Users\Brian\AppData\Local\Temp\Rtmpk1dCJ0/public_clusters/PublicClusterNetwork.pdf
    #> Network igraph saved in edgelist format to file:
    #>   C:\Users\Brian\AppData\Local\Temp\Rtmpk1dCJ0/public_clusters/PublicClusterNetwork_EdgeList.txt
    #> Adjacency matrix saved to file:
    #>   C:\Users\Brian\AppData\Local\Temp\Rtmpk1dCJ0/public_clusters/PublicClusterNetwork_AdjacencyMatrix.mtx
...
#>   C:\Users\Brian\AppData\Local\Temp\Rtmpk1dCJ0/public_clusters/PubClustByRepresentative.rda
```

<img src="man/figures/README-unnamed-chunk-36-1.png" width="100%" style="display: block; margin: auto;" />

    #> Network graph plots saved to file:
    #>   C:\Users\Brian\AppData\Local\Temp\Rtmpk1dCJ0/public_clusters/PubClustByRepresentative.pdf
    #> All tasks complete.
